...
namespace RN
{
	...
	void Water::Initialize()
	{
		...
		if(_camera != 0)
		{
			_reflection = new Camera(Vector2(512, 512), Texture::Parameter::Format::RGBA8888, Camera::FlagUpdateStorageFrame|Camera::FlagHidden, RenderStorage::BufferFormatComplete, 1.0f);
