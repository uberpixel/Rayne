					...
					if(lightManager != nullptr)
					{
						...
						if(lightPointCount >= _maxLightFastPath || lightSpotCount >= _maxLightFastPath)
						{
							...
							if(program->lightPointList != -1)
							{
								...
								gl::Uniform1i(program->lightPointList, textureUnit);
							}
							...
							if(program->lightPointListOffset != -1)
							{
								...
								gl::Uniform1i(program->lightPointListOffset, textureUnit);
							}
							...
							if(program->lightPointListData != -1)
							{
								...
								gl::Uniform1i(program->lightPointListData, textureUnit);
							}
							...
							if(program->lightSpotList != -1)
							{
								...
								gl::Uniform1i(program->lightSpotList, textureUnit);
							}
							...
							if(program->lightSpotListOffset!= -1)
							{
								...
								gl::Uniform1i(program->lightSpotListOffset, textureUnit);
							}
							...
							if(program->lightSpotListData != -1)
							{
								...
								gl::Uniform1i(program->lightSpotListData, textureUnit);
							}
						}
					}
