...
macro(rayne_link_with _TARGET)
    ...
    if(IOS)
        ...
        if(CURRENT_EMBED_FRAMEWORKS)
            set_property(TARGET ${_TARGET} PROPERTY XCODE_EMBED_FRAMEWORKS ${CURRENT_EMBED_FRAMEWORKS} Rayne)
        else()
            set_property(TARGET ${_TARGET} PROPERTY XCODE_EMBED_FRAMEWORKS Rayne)
        endif()
