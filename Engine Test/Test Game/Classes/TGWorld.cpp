...
//		srand(time(0));
	...
	void World::CreateSponza()
	{
		...
		model->GetMaterialAtIndex(0, 12)->SetOverride(RN::Material::Override::GroupDiscard);
		
		model->GetMaterialAtIndex(0, 17)->SetDiscard(true);
		model->GetMaterialAtIndex(0, 17)->SetCullMode(RN::Material::CullMode::None);
		model->GetMaterialAtIndex(0, 17)->SetOverride(RN::Material::Override::GroupDiscard);
		
		model->GetMaterialAtIndex(0, 22)->SetDiscard(true);
		model->GetMaterialAtIndex(0, 22)->SetCullMode(RN::Material::CullMode::None);
		model->GetMaterialAtIndex(0, 22)->SetOverride(RN::Material::Override::GroupDiscard);
...
//		_lightcam->clipfar = 100.0f;
	...
	void World::CreateForest()
	{
		...
		ground->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::Culling);
...
#define TREE_MODEL_COUNT 10
		...
		trees[0]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[0]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[0]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.1f);
		trees[0]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[0]->GetMaterialAtIndex(0, 0)->Define("RN_VEGETATION");
		trees[0]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[0]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[0]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.1f);
		trees[0]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[0]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[0]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[0]->GetMaterialAtIndex(1, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[0]->GetMaterialAtIndex(1, 0)->SetDiscard(true);
		trees[0]->GetMaterialAtIndex(1, 0)->SetDiscardThreshold(0.1f);
		trees[0]->GetMaterialAtIndex(1, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[0]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[0]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[0]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[0]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[0]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[1]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[1]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[1]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.1f);
		trees[1]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[1]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[1]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[1]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[1]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[1]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[1]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[1]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		progress->IncrementCompletedUnits(5);
		
		trees[2] = RN::Model::WithFile("models/pure3d/BirchTrees/birch11m.sgm");
		trees[2]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[2]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[2]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.1f);
		trees[2]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[2]->GetMaterialAtIndex(0, 0)->Define("RN_VEGETATION");
		trees[2]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[2]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[2]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.1f);
		trees[2]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[2]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[2]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[2]->GetMaterialAtIndex(1, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[2]->GetMaterialAtIndex(1, 0)->SetDiscard(true);
		trees[2]->GetMaterialAtIndex(1, 0)->SetDiscardThreshold(0.1f);
		trees[2]->GetMaterialAtIndex(1, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[2]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[2]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[2]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[2]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[2]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[3]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[3]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[3]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.1f);
		trees[3]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[3]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[3]->GetMaterialAtIndex(0, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[3]->GetMaterialAtIndex(0, 2)->SetDiscard(true);
		trees[3]->GetMaterialAtIndex(0, 2)->SetDiscardThreshold(0.1f);
		trees[3]->GetMaterialAtIndex(0, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[3]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[3]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[3]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[3]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[3]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[3]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[3]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		trees[3]->GetMaterialAtIndex(1, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[3]->GetMaterialAtIndex(1, 2)->SetDiscard(true);
		trees[3]->GetMaterialAtIndex(1, 2)->SetDiscardThreshold(0.1f);
		trees[3]->GetMaterialAtIndex(1, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[3]->GetMaterialAtIndex(1, 2)->Define("RN_VEGETATION");
		progress->IncrementCompletedUnits(5);
		
		trees[4] = RN::Model::WithFile("models/pure3d/BirchTrees/birch18m.sgm");
		trees[4]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[4]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[4]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.1f);
		trees[4]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[4]->GetMaterialAtIndex(0, 0)->Define("RN_VEGETATION");
		trees[4]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[4]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[4]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.1f);
		trees[4]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[4]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[4]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[4]->GetMaterialAtIndex(1, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[4]->GetMaterialAtIndex(1, 0)->SetDiscard(true);
		trees[4]->GetMaterialAtIndex(1, 0)->SetDiscardThreshold(0.1f);
		trees[4]->GetMaterialAtIndex(1, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[4]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[4]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[4]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[4]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[4]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[5]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[5]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[5]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.1f);
		trees[5]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[5]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[5]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[5]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.1f);
		trees[5]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[5]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		progress->IncrementCompletedUnits(5);
		
		trees[6] = RN::Model::WithFile("models/pure3d/PineTrees/pine4m.sgm");
		trees[6]->GetMaterialAtIndex(0, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(0, 0)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(0, 0)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[6]->GetMaterialAtIndex(0, 0)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[6]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(1, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(1, 0)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(1, 0)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(1, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[6]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[6]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(1, 2)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(2, 0)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(2, 0)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(2, 0)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(2, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[6]->GetMaterialAtIndex(2, 0)->Define("RN_VEGETATION");
		trees[6]->GetMaterialAtIndex(2, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[6]->GetMaterialAtIndex(2, 1)->SetDiscard(true);
		trees[6]->GetMaterialAtIndex(2, 1)->SetDiscardThreshold(0.5f);
		trees[6]->GetMaterialAtIndex(2, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[7]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[7]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(0, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(0, 2)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(0, 2)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(0, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[7]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[7]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(1, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(1, 2)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(1, 2)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(1, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[7]->GetMaterialAtIndex(1, 2)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(2, 0)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(2, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(2, 1)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(2, 1)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(2, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[7]->GetMaterialAtIndex(2, 1)->Define("RN_VEGETATION");
		trees[7]->GetMaterialAtIndex(2, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[7]->GetMaterialAtIndex(2, 2)->SetDiscard(true);
		trees[7]->GetMaterialAtIndex(2, 2)->SetDiscardThreshold(0.5f);
		trees[7]->GetMaterialAtIndex(2, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[8]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[8]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[8]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.5f);
		trees[8]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[8]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(0, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[8]->GetMaterialAtIndex(0, 2)->SetDiscard(true);
		trees[8]->GetMaterialAtIndex(0, 2)->SetDiscardThreshold(0.5f);
		trees[8]->GetMaterialAtIndex(0, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[8]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[8]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[8]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.5f);
		trees[8]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[8]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(1, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[8]->GetMaterialAtIndex(1, 2)->SetDiscard(true);
		trees[8]->GetMaterialAtIndex(1, 2)->SetDiscardThreshold(0.5f);
		trees[8]->GetMaterialAtIndex(1, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[8]->GetMaterialAtIndex(1, 2)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(2, 0)->Define("RN_VEGETATION");
		trees[8]->GetMaterialAtIndex(2, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[8]->GetMaterialAtIndex(2, 1)->SetDiscard(true);
		trees[8]->GetMaterialAtIndex(2, 1)->SetDiscardThreshold(0.5f);
		trees[8]->GetMaterialAtIndex(2, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		trees[9]->GetMaterialAtIndex(0, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[9]->GetMaterialAtIndex(0, 1)->SetDiscard(true);
		trees[9]->GetMaterialAtIndex(0, 1)->SetDiscardThreshold(0.5f);
		trees[9]->GetMaterialAtIndex(0, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[9]->GetMaterialAtIndex(0, 1)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(0, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[9]->GetMaterialAtIndex(0, 2)->SetDiscard(true);
		trees[9]->GetMaterialAtIndex(0, 2)->SetDiscardThreshold(0.5f);
		trees[9]->GetMaterialAtIndex(0, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[9]->GetMaterialAtIndex(0, 2)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(1, 0)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(1, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[9]->GetMaterialAtIndex(1, 1)->SetDiscard(true);
		trees[9]->GetMaterialAtIndex(1, 1)->SetDiscardThreshold(0.5f);
		trees[9]->GetMaterialAtIndex(1, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[9]->GetMaterialAtIndex(1, 1)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(1, 2)->SetCullMode(RN::Material::CullMode::None);
		trees[9]->GetMaterialAtIndex(1, 2)->SetDiscard(true);
		trees[9]->GetMaterialAtIndex(1, 2)->SetDiscardThreshold(0.5f);
		trees[9]->GetMaterialAtIndex(1, 2)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		trees[9]->GetMaterialAtIndex(1, 2)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(2, 0)->Define("RN_VEGETATION");
		trees[9]->GetMaterialAtIndex(2, 1)->SetCullMode(RN::Material::CullMode::None);
		trees[9]->GetMaterialAtIndex(2, 1)->SetDiscard(true);
		trees[9]->GetMaterialAtIndex(2, 1)->SetDiscardThreshold(0.5f);
		trees[9]->GetMaterialAtIndex(2, 1)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
		...
		grass->GetMaterialAtIndex(0, 0)->SetOverride(RN::Material::Override::GroupDiscard|RN::Material::Override::Culling);
