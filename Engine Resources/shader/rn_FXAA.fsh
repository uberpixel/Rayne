...
----------------------------------------------------------------------------*/
    float3 rgbN = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 0,-1)).xyz;
    float3 rgbW = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( -1,0)).xyz;
    float3 rgbM = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 0, 0)).xyz;
    float3 rgbE = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 1, 0)).xyz;
    float3 rgbS = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 0,1)).xyz;
...
----------------------------------------------------------------------------*/
    float3 rgbNW = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( -1,-1)).xyz;
    float3 rgbNE = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 1,-1)).xyz;
    float3 rgbSW = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( -1, 1)).xyz;
    float3 rgbSE = textureLodOffset(tex, pos.xy, 0.0, FxaaInt2( 1, 1)).xyz;
...
void main()
{
	fragColor0 = vec4(FxaaPixelShader(vertTexcoord, targetmap0, frameSize.xy), 1.0f);
}
