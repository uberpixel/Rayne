...
//	blurTexcoords[ 2] = texcoord + vec2(0.0, -0.020);
	blurTexcoords[ 0] = texcoord + vec2(0.0, -0.016);
	blurTexcoords[ 1] = texcoord + vec2(0.0, -0.012);
	blurTexcoords[ 2] = texcoord + vec2(0.0, -0.008);
	blurTexcoords[ 3] = texcoord + vec2(0.0, -0.004);
	blurTexcoords[ 4] = texcoord + vec2(0.0,  0.004);
	blurTexcoords[ 5] = texcoord + vec2(0.0,  0.008);
	blurTexcoords[ 6] = texcoord + vec2(0.0,  0.012);
	blurTexcoords[ 7] = texcoord + vec2(0.0,  0.016);
