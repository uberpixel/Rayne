...
//	blurTexcoords[ 2] = texcoord + vec2(-0.020, 0.0);
	blurTexcoords[ 0] = texcoord + vec2(-0.016, 0.0);
	blurTexcoords[ 1] = texcoord + vec2(-0.012, 0.0);
	blurTexcoords[ 2] = texcoord + vec2(-0.008, 0.0);
	blurTexcoords[ 3] = texcoord + vec2(-0.004, 0.0);
	blurTexcoords[ 4] = texcoord + vec2( 0.004, 0.0);
	blurTexcoords[ 5] = texcoord + vec2( 0.008, 0.0);
	blurTexcoords[ 6] = texcoord + vec2( 0.012, 0.0);
	blurTexcoords[ 7] = texcoord + vec2( 0.016, 0.0);
