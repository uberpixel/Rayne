...
[[early_fragment_tests]] fragment float4 pp_blit_fragment(FragmentVertex vert [[stage_in]], texture2d<float> texture0 [[texture(0)]], sampler linearClampSampler [[sampler(0)]])
{
...
[[early_fragment_tests]] fragment float4 pp_mask_fragment(FragmentVertex vert [[stage_in]])
{
	return float4(1.0);
}
